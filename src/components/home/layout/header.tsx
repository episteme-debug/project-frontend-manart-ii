                        ...
                        {productosFiltrados.length > 5 && (
                          <div className="p-3 border-t border-gray-100">
                            <button
                              ...
                              disabled={isNavigating}
                              className="w-full text-center text-green-600 hover:text-green-700 font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                            >
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="p-2 hover:bg-green-50 rounded-lg transition-smooth"
                >
                ...
                {isUserMenuOpen && (
                  <div className="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border py-2 z-50">
                    ...
                    <button
                      className="flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 w-full text-left"
                    >
            ...
            <div className="lg:hidden mt-4 glass rounded-2xl p-6">
              <div className="space-y-4">
                ...
                <nav className="space-y-2">
                  <Link href="/home" className="block py-2 text-black hover:text-green-600 transition-smooth" prefetch={true}>
                    Inicio
                  </Link>
                  <Link
                    href="/sobre-nosotros"
                  ...
                  <Link href="/catalogo" className="block py-2 text-gray-700 hover:text-green-600 transition-smooth" prefetch={true}>
                    Catálogo de Productos
                  </Link>
                  <Link href="/blog" className="block py-2 text-gray-700 hover:text-green-600 transition-smooth" prefetch={true}>
                    Blog Artesanales
                  </Link>
                </nav>
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="space-y-2">
                    <Link href="/login" className="flex items-center gap-3 py-2 text-gray-700 hover:text-green-600 transition-smooth" prefetch={true}>
                      <LogIn className="w-4 h-4" />
                      Iniciar Sesión
                    </Link>
                    <Link href="/registro" className="flex items-center gap-3 py-2 text-gray-700 hover:text-green-600 transition-smooth" prefetch={true}>
                      <UserPlus className="w-4 h-4" />
                      Registrarse
                    </Link>
                    <Link href="/dashboard" className="flex items-center gap-3 py-2 text-gray-700 hover:text-green-600 transition-smooth" prefetch={true}>
                      <Settings className="w-4 h-4" />
                      Mi Cuenta
                    </Link>
                    <button className="flex items-center gap-3 py-2 text-red-600 hover:text-red-700 transition-smooth w-full text-left">
                      <LogOut className="w-4 h-4" />
                      Cerrar Sesión
                    </button>
                  </div>
